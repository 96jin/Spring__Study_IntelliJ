...
//
//        com.fastcampus.ch3.Car car = (com.fastcampus.ch3.Car)ac.getBean("car");   // byName으로 객체를 검색
//        com.fastcampus.ch3.Door door = (com.fastcampus.ch3.Door)ac.getBean(com.fastcampus.ch3.Door.class);  // byType으로 객체를 검색
